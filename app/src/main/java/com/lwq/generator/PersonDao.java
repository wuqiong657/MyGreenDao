...
import com.lwq.generator.Person;
...
public class PersonDao extends AbstractDao<Person, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsGraduated = new Property(3, Boolean.class, "isGraduated", false, "IS_GRADUATED");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'PERSON' (" + //
                ...
                "'NAME' TEXT," + // 1: name
                "'AGE' INTEGER," + // 2: age
                "'IS_GRADUATED' INTEGER);"); // 3: isGraduated
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Person entity) {
        ...
        Boolean isGraduated = entity.getIsGraduated();
        if (isGraduated != null) {
            stmt.bindLong(4, isGraduated ? 1l: 0l);
        }
    }
    ...
    public Person readEntity(Cursor cursor, int offset) {
        Person entity = new Person( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getShort(offset + 3) != 0 // isGraduated
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Person entity, int offset) {
        ...
        entity.setIsGraduated(cursor.isNull(offset + 3) ? null : cursor.getShort(offset + 3) != 0);
     }
